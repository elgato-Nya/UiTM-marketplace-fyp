 ...
 *
 * PURPOSE: Store contact form submissions for bug reports, enquiries, feedback, and collaboration requests
 * SCOPE: Platform communication and issue tracking
 * FEATURES:
 * - Multiple submission types (bug, enquiry, feedback, collaboration)
...
const contactSchema = new mongoose.Schema(
  {
    ...
    type: {
      type: String,
      enum: ["bug", "enquiry", "feedback", "collaboration", "other"],
