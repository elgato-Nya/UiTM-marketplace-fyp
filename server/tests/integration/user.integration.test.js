...
describe("User Model", () => {
  ...
  describe("create user", () => {
    ...
    it("should create a user with a valid data and hashed password", async () => {
      ...
      expect(savedUser.role).toStrictEqual(testUser.role);
  ...
  describe("Advanced Integration Tests", () => {
    ...
    it("should handle merchant details validation", async () => {
      ...
      expect(savedMerchant.role).toContain("merchant");
    ...
    it("should handle multiple roles", async () => {
      ...
      expect(savedUser.role).toContain("consumer");
      expect(savedUser.role).toContain("merchant");
      expect(savedUser.role).toHaveLength(2);
    });
    ...
    it("should handle default values correctly", async () => {
      ...
      expect(savedUser.role).toEqual(["consumer"]);
